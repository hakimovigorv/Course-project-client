                    ...
                    <div className="container">
                        <div className="card">
                            ...
                            <div className="card-body d-flex justify-content-between">
                                ...
                                <span>
                                    {this.state.likeCount} people liked this review!
                                    {
                                        this.state.like ? (
                                                <button className="btn btn-dark-outline" name="block" data-bs-toggle="tooltip"
                                                        title="Dislike"
                        ...
                        <div>
                            <h3>Comments:</h3>
                            {
                                review.comments ? (<span/>) :
                                    (<span>There are no comments yet :C</span>)
                            }
                        </div>
                    </div>
                )}
